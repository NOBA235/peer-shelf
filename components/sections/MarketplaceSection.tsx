      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-0.5 text-sm text-[#52525B]">{listings.length} resources available near you</p>
          </div>
          <button
            onClick={onRequest}
            className="h-10 rounded-md border border-[#E4E4E7] bg-white px-4 text-sm font-medium text-[#18181B] transition hover:border-[#18181B] hover:bg-[#FAFAFA] focus:outline-none focus:ring-2 focus:ring-[#18181B] focus:ring-offset-2"
          >
            🔖 Request
          </button>
        </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <button
            ...
            className={`relative h-10 flex-shrink-0 rounded-md border px-4 text-sm font-medium transition focus:outline-none focus:ring-2 focus:ring-[#18181B] focus:ring-offset-2 ${
              showFilters
          ...
          >
            Filters
            {activeFilters > 0 && (
              <span className="absolute -right-1 -top-1 flex h-4 w-4 items-center justify-center rounded-full bg-[#18181B] text-[10px] font-bold text-white">
                {activeFilters}
              </span>
            )}
          </button>
        ...
        {/* Advanced filters */}
        {showFilters && (
          <div className="rounded-xl border border-[#E4E4E7] bg-white p-4 space-y-4">
              ...
              {[
                ...
                <div key={label as string}>
                  ...
                  <select
                    ...
                    className="mt-1 w-full rounded-md border border-[#E4E4E7] bg-white px-3 py-2 text-sm text-[#18181B] focus:border-[#18181B] focus:outline-none focus:ring-2 focus:ring-[#18181B]/10"
                  >
